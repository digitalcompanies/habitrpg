...
api.userDefaults =
  habits: [
    {text: t('defaultHabit1Text'), notes: t('defaultHabit1Text'), value: 0, up: true, down: false, attribute: 'per'}
    {text: t('defaultHabit2Text'), notes: t('defaultHabit2Text'), value: 0, up: false, down: true, attribute: 'str'}
    {text: t('defaultHabit3Text'), notes: t('defaultHabit3Text'), value: 0, up: true, down: true, attribute: 'str'}
  ]

  dailys: [
#    {text: t('defaultDaily1Text'), notes: t('defaultDaily1Notes'), value: 0, completed: false, repeat: repeat, attribute: 'per' }
#    {text: t('defaultDaily2Text'), notes: t('defaultDaily2Notes'), value: 3, completed: false, repeat: repeat, attribute: 'con' }
#    {text: t('defaultDaily3Text'), notes: t('defaultDaily3Notes'), value: -10, completed: false, repeat: repeat, attribute: 'int' }
#    {text: t('defaultDaily4Text'), notes: t('defaultDaily4Notes'), checklist: [{completed: true, text: t('defaultDaily4Checklist1') }, {completed: false, text: t('defaultDaily4Checklist2')}, {completed: false, text: t('defaultDaily4Checklist3')}], completed: false, repeat: repeat, attribute: 'str' }
  ]

  todos: [
    {text: t('defaultTodo1Text'), notes: t('defaultTodoNotes'), completed: false, attribute: 'int' }
#    {text: t('defaultTodo2Text'), notes: t('defaultTodoNotes'), checklist: [{completed: false, text: t('defaultTodo2Checklist1') }, {completed: false, text: t('defaultTodo2Checklist2')}, {completed: false, text: t('defaultTodo2Checklist3')}], completed: false, attribute: 'per' }
#    {text: t('defaultTodo3Text'), notes: t('defaultTodoNotes'), checklist: [{completed: false, text: t('defaultTodo3Checklist1') }, {completed: false, text: t('defaultTodo3Checklist2')}, {completed: false, text: t('defaultTodo3Checklist3')}], completed: false, attribute: 'per' }
#    {text: t('defaultTodo4Text'), notes: t('defaultTodoNotes'), checklist: [{completed: false, text: t('defaultTodo4Checklist1') }, {completed: false, text: t('defaultTodo4Checklist2')}, {completed: false, text: t('defaultTodo4Checklist3')}], completed: false, attribute: 'per' }
#    {text: t('defaultTodo5Text'), notes: t('defaultTodoNotes'), completed: false, attribute: 'per' }
  ]

  rewards: [
#   {text: t('defaultReward1Text'), notes: t('defaultReward1Text'), value: 10 }
#   {text: t('defaultReward2Text'), notes: t('defaultReward2Text'), value: 10 }
  ]
...
_.each {habits:'habit', dailys:'daily', todos:'todo', rewards:'reward'}, (v,k) ->
  _.each api.userDefaults[k], (task,i)->
    task.type = v
    task.sort = i
